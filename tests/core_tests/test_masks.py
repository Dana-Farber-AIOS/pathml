...
def smallmasks():
    ...
    testmasks = Masks(h5manager=pathml.core.h5managers.h5pathManager(slidedata=slidedata), masks={'mask1': im, 'mask2': im})
    return testmasks
...
def test_init_incorrect_input(incorrect_input):
    ...
    with pytest.raises(ValueError):
        masks = Masks(h5manager=pathml.core.h5managers.h5pathManager(slidedata=slidedata), masks=incorrect_input)
